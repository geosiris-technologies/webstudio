...
public class CoreHandler_WebStudio extends CoreHandler{
    public static Logger logger = LogManager.getLogger(CoreHandler_WebStudio.class);

    @Override
    public Collection<Message> on_Acknowledge(Acknowledge msg, MessageHeader msgHeader, ClientInfo clientInfo) {
        logger.info("[CoreHandler_WebStudio] received message" + msg);
