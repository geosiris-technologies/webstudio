...
export const __XYZ_COORD_RGX__ = "[-+]?([0-9]*[.])?[0-9]+([eE][-+]?\\d+)?";
export const __XYZ_POINT_RGX__ = "(?<x>"+__XYZ_COORD_RGX__ + ")\\s+(?<y>"+__XYZ_COORD_RGX__ + ")\\s+(?<z>"+__XYZ_COORD_RGX__ + ")";
export const __XYZ_POINT_REGEXP__ = new RegExp("\\s*" + __XYZ_POINT_RGX__ + "\\s*", "");
